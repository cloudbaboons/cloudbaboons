...
import { CbHealthCheckComponent } from '../../../../../../main/webapp/app/admin/health/health.component';
import { CbHealthService } from '../../../../../../main/webapp/app/admin/health/health.service';


describe('Component Tests', () => {

    describe('CbHealthCheckComponent', () => {

        let comp: CbHealthCheckComponent;
        let fixture: ComponentFixture<CbHealthCheckComponent>;
        let service: CbHealthService;

        beforeEach(async(() => {
            TestBed.configureTestingModule({
                imports: [CloudbaboonsTestModule],
                declarations: [CbHealthCheckComponent],
                providers: [
                    CbHealthService,
                    {
                        provide: NgbModal,
            ...
            }).overrideTemplate(CbHealthCheckComponent, '')
            .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(CbHealthCheckComponent);
            comp = fixture.componentInstance;
            service = fixture.debugElement.injector.get(CbHealthService);
        });
